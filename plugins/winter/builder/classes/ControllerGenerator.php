...
class ControllerGenerator
{
    ...
    protected function setTemplateVars()
    {
        ...
        [$author, $plugin] = explode('.', $this->templateVars['pluginCode']); 

        
        $author = strtolower($author);
        $plugin = strtolower($plugin);
        $this->templateVars['controller'] = $author . '.' .$plugin . '::lang.controller' .'.' .  strtolower($this->sourceModel->controller) .'.' .strtolower($this->sourceModel->controller);
        $this->templateVars['NameClasscontroller'] = $this->sourceModel->controller;
